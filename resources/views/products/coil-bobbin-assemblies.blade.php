...
<div class="row">
  <div class="col-12">
    ...
    <img src="{{ asset('/assets/images/products/simcoltd-mac-movement-competitors.jpg') }}"  class="float-left" style="width:40%;" alt="">
    <h5>The Micro Movement is small as a dime yet performs as a giant against its competition.</h5>
    <p class="pb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis commodo odio aenean sed. Enim nunc faucibus a pellentesque sit amet. Nisl nisi scelerisque eu ultrices vitae auctor eu. Tellus at urna condimentum mattis pellentesque. Arcu risus quis varius quam. Consectetur adipiscing elit ut aliquam purus. Rhoncus mattis rhoncus urna neque viverra justo nec ultrices. Ultricies integer quis auctor elit. Elit ullamcorper dignissim cras tincidunt lobortis feugiat. Eu tincidunt tortor aliquam nulla. Risus commodo viverra maecenas accumsan lacus vel facilisis volutpat. Duis ut diam quam nulla porttitor massa id.</p>
