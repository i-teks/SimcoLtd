...
@section('content')
  ...
  U.S. patents: 5,686,832; 6,046,583 & 6,323,637 Japan patent: 4017666
  <p>
    The MAC movement can be found in high profile vehicles such as:
    <ul>
      <li>Dodge SRT-10</li>
      <li>Ford GT</li>
      <li>Chevrolet Cobalt</li>
      <li>Saturn Ion Redline</li>
      <li>Saleen Specialty OEM</li>
      <li>NASCAR</li>
      <li>Harley Davidson Motorcycles</li>
      <li>Bombardier ATV</li>
    </ul>
  </p>
@endsection
