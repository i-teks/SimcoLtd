...
<div class="row">
  <div class="col-12">
    ...
    <div class="text-center"><img src="{{ asset('/assets/images/headers/header-industries-recreation.jpg') }}" style="width:100%; height:auto;" alt=""></div>
...
<div id="boxed-content" class="row mx-0" style="background-color: #eee;">
  <div class="col-12 col-sm-7" style="padding:0;">
    <img src="{{ asset('/assets/images/industries/industries-recreation.png') }}" width="100%" height="100%" style="object-fit: cover; object-position:center right" alt="">
  </div>
