...
@section('title')
  Industries - Specialty OEM - Simco Ltd. Specialty Innovation and Manufacturing Company
@endsection
...
<div class="row">
  <div class="col-12">
    <h1>Specialty OEM</h1>
    <div class="text-center"><img src="{{ asset('/assets/images/headers/header-industries-oem.jpg') }}" style="width:100%; height:auto;" alt=""></div>
